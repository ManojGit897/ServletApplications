...
public class BOIBank implements ATMCardServer{
	...
	public BOIBank() {
		System.out.println("~ WEL-COME to Bank OF India ATM Services ~");
		customer.put("Manojkumar",8876_5432_1123_4561L);
		customer.put("manu",8876_5432_1123_4562L);
		customer.put("Divya",8876_5432_1123_4563L);
		customer.put("Dharani",8876_5432_1123_4564L);
		customer.put("ganesh",8876_5432_1123_4565L);
		customer.put("Laksmi",8876_5432_1123_4566L);
		customer.put("Linga ",8876_5432_1123_4567L);
		customer.put("Mallika",8876_5432_1123_4568L);
	}
